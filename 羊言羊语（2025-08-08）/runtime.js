...
! function() {
    ...
    r.m = e,
            ...
            r.O = function(e, t, o, u) {
                if (!t) {
                    ...
                    for (l = 0; l < n.length; l++) {
                        ...
                        for (var f = !0, c = 0; c < t.length; c++)(!1 & u || i >= u) && Object.keys(r.O).every((function(n) {
                            return r.O[n](t[c])
                        })) ? t.splice(c--, 1) : (f = !1, u < i && (i = u));
                        if (f) {
                            n.splice(l--, 1);
                            var a = o();
                            void 0 !== a && (e = a)
        ...
        function() {
            var e, t = Object.getPrototypeOf ? function(n) {
            ...
            r.t = function(o, u) {
                ...
                e = e || [null, t({}), t([]), t(t)];
                for (var c = 2 & u && o;
                    "object" == n(c) && !~e.indexOf(c); c = t(c)) Object.getOwnPropertyNames(c).forEach((function(n) {
                    f[n] = function() {
                        return o[n]
                    }
                }));
